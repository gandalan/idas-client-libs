 ...
 * @typedef {import('../dtos/index.js').BelegStatusDTO} BelegStatusDTO
 * @typedef {import('../dtos/index.js').VorgangDTO} VorgangDTO
 * @typedef {import('../dtos/index.js').BelegartWechselDTO} BelegartWechselDTO
 * @typedef {import('../dtos/index.js').VorgangListItemDTO} VorgangListItemDTO
 * @typedef {import('../dtos/index.js').VorgangStatusDTO} VorgangStatusDTO
 * @typedef {import('../dtos/index.js').VorgangStatusTableDTO} VorgangStatusTableDTO
 * @typedef {import('../dtos/index.js').BaseListItemDTO} BaseListItemDTO
 */
...
export function createBelegApi(fluentApi) {
  return {
     ...
     * @returns {Promise<import('../dtos/index.js').VorgangHistorienDTO>}
     */
     ...
     * @param {string} belegGuid
     * @param {boolean} [includePositionen=false]
     * @returns {Promise<import('../dtos/index.js').BelegHistorienDTO>}
     */
     ...
     * @returns {Promise<import('../dtos/index.js').BelegPositionHistorienDTO>}
     */
     ...
     * @returns {Promise<import('../dtos/index.js').SerieHistorieDTO[]>}
     */
     ...
     * Add vorgang history
     * @param {string} vorgangGuid
     * @param {import('../dtos/index.js').VorgangHistorieDTO} historyDto
     * @returns {Promise<void>}
     */
     ...
     * Add beleg history
     * @param {string} belegGuid
     * @param {import('../dtos/index.js').BelegHistorieDTO} historyDto
     * @returns {Promise<void>}
     */
     ...
     * @param {string} positionGuid
     * @param {import('../dtos/index.js').BelegPositionHistorieDTO} historyDto
     * @returns {Promise<void>}
     */
    ...
    /**
     * Add serie history
     * @param {import('../dtos/index.js').SerieHistorieDTO} historyDto
     * @returns {Promise<void>}
     */
